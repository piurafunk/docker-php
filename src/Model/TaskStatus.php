...
class TaskStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'timestamp' => 'string',
        'state' => '\Piurafunk\Docker\Model\TaskState',
        'message' => 'string',
        'err' => 'string',
        'containerStatus' => '\Piurafunk\Docker\Model\TaskStatusContainerStatus'
    ];
     ...
     * Sets state
     *
     * @param \Piurafunk\Docker\Model\TaskState|null $state state
     *
     * @return $this
     */
     ...
     *
     * @return \Piurafunk\Docker\Model\TaskStatusContainerStatus|null
     */
     ...
     *
     * @param \Piurafunk\Docker\Model\TaskStatusContainerStatus|null $containerStatus containerStatus
     *
     * @return $this
     */
