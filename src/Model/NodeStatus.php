 ...
 *
 * @category Class
 * @description NodeStatus represents the status of a node.  It provides the current status of the node, as seen by the manager.
 * @package  Piurafunk\Docker
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NodeStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'state' => '\Piurafunk\Docker\Model\NodeState',
        'message' => 'string',
        'addr' => 'string'
    ];
     ...
     * Gets state
     *
     * @return \Piurafunk\Docker\Model\NodeState|null
     */
     ...
     * Sets state
     *
     * @param \Piurafunk\Docker\Model\NodeState|null $state state
     *
     * @return $this
     */
     ...
     * Sets addr
     *
     * @param string|null $addr IP address of the node.
     *
     * @return $this
     */
