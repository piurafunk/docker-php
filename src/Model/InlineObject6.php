...
class InlineObject6 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['remoteAddrs'] = isset($data['remoteAddrs']) ? $data['remoteAddrs'] : null;
        $this->container['joinToken'] = isset($data['joinToken']) ? $data['joinToken'] : null;
    }
     ...
     * Sets listenAddr
     *
     * @param string|null $listenAddr Listen address used for inter-manager communication if the node gets promoted to manager, as well as determining the networking interface used for the VXLAN Tunnel Endpoint (VTEP).
     *
     * @return $this
     */
    ...
    {
        return $this->container['remoteAddrs'];
    }

    /**
     * Sets remoteAddrs
     *
     * @param string[]|null $remoteAddrs Addresses of manager nodes already participating in the swarm.
     *
     * @return $this
     */
    public function setRemoteAddrs($remoteAddrs)
    {
        $this->container['remoteAddrs'] = $remoteAddrs;
    ...
    {
        return $this->container['joinToken'];
    }

    /**
     * Sets joinToken
     *
     * @param string|null $joinToken Secret token for joining this swarm.
     *
     * @return $this
     */
    public function setJoinToken($joinToken)
    {
        $this->container['joinToken'] = $joinToken;
