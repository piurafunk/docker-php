...
class PluginConfigInterface implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Plugin_Config_Interface';
    ...
    protected static $openAPITypes = [
        'types' => '\Piurafunk\Docker\Model\PluginInterfaceType[]',
        'socket' => 'string',
    ...
    const PROTOCOL_SCHEME_EMPTY = '';
    const PROTOCOL_SCHEME_MOBY_PLUGINS_HTTP_V1 = 'moby.plugins.http/v1';
     ...
     * @return string[]
     */
    public function getProtocolSchemeAllowableValues()
    {
        return [
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['protocolScheme'] = isset($data['protocolScheme']) ? $data['protocolScheme'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['protocolScheme']) && !in_array($this->container['protocolScheme'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'protocolScheme', must be one of '%s'",
     ...
     * Gets types
     *
     * @return \Piurafunk\Docker\Model\PluginInterfaceType[]
     */
     ...
     * Sets types
     *
     * @param \Piurafunk\Docker\Model\PluginInterfaceType[] $types types
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getProtocolSchemeAllowableValues();
        if (!is_null($protocolScheme) && !in_array($protocolScheme, $allowedValues, true)) {
