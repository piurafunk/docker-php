...
class TaskSpecRestartPolicy implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['maxAttempts'] = isset($data['maxAttempts']) ? $data['maxAttempts'] : 0;
     ...
     * Sets maxAttempts
     *
     * @param int|null $maxAttempts Maximum attempts to restart a given container before giving up (default value is 0, which is ignored).
     *
     * @return $this
     */
