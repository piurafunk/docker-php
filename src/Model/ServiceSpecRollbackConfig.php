...
class ServiceSpecRollbackConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceSpec_RollbackConfig';
     ...
     * Sets parallelism
     *
     * @param int|null $parallelism Maximum number of tasks to be rolled back in one iteration (0 means unlimited parallelism).
     *
     * @return $this
     */
     ...
     * Sets delay
     *
     * @param int|null $delay Amount of time between rollback iterations, in nanoseconds.
     *
     * @return $this
     */
     ...
     * Sets failureAction
     *
     * @param string|null $failureAction Action to take if an rolled back task fails to run, or stops running during the rollback.
     *
     * @return $this
     */
     ...
     * Sets monitor
     *
     * @param int|null $monitor Amount of time to monitor each rolled back task for failures, in nanoseconds.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $maxFailureRatio The fraction of tasks that may fail during a rollback before the failure action is invoked, specified as a floating point number between 0 and 1.
     *
     * @return $this
     */
     ...
     * Sets order
     *
     * @param string|null $order The order of operations when rolling back a task. Either the old task is shut down before the new task is started, or the new task is started before the old task is shut down.
     *
     * @return $this
     */
