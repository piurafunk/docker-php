...
class ServiceSpecUpdateConfig implements ModelInterface, ArrayAccess
{
     ...
     * Sets failureAction
     *
     * @param string|null $failureAction Action to take if an updated task fails to run, or stops running during the update.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $maxFailureRatio The fraction of tasks that may fail during an update before the failure action is invoked, specified as a floating point number between 0 and 1.
     *
     * @return $this
     */
