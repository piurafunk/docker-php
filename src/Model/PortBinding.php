 ...
 * @link     https://openapi-generator.tech
 */
class PortBinding implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortBinding';
     ...
     * Sets hostIp
     *
     * @param string|null $hostIp Host IP address that the container's port is mapped to.
     *
     * @return $this
     */
     ...
     * Sets hostPort
     *
     * @param string|null $hostPort Host port number that the container's port is mapped to.
     *
     * @return $this
     */
