...
class InlineObject4 implements ModelInterface, ArrayAccess
{
     ...
     * Sets container
     *
     * @param string|null $container The ID or name of the container to disconnect from the network.
     *
     * @return $this
     */
     ...
     * Sets force
     *
     * @param bool|null $force Force the container to disconnect from the network.
     *
     * @return $this
     */
