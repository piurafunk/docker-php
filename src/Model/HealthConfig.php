 ...
 * @link     https://openapi-generator.tech
 */
class HealthConfig implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['startPeriod'] = isset($data['startPeriod']) ? $data['startPeriod'] : null;
    }
    ...
    {
        return $this->container['startPeriod'];
    }

    /**
     * Sets startPeriod
     *
     * @param int|null $startPeriod Start period for the container to initialize before starting health-retries countdown in nanoseconds. It should be 0 or at least 1000000 (1 ms). 0 means inherit.
     *
     * @return $this
     */
    public function setStartPeriod($startPeriod)
    {
        $this->container['startPeriod'] = $startPeriod;
