 ...
 * @link     https://openapi-generator.tech
 */
class IndexInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IndexInfo';
     ...
     * Sets name
     *
     * @param string|null $name Name of the registry, such as \"docker.io\".
     *
     * @return $this
     */
     ...
     * Sets mirrors
     *
     * @param string[]|null $mirrors List of mirrors, expressed as URIs.
     *
     * @return $this
     */
     ...
     * Sets secure
     *
     * @param bool|null $secure Indicates if the registry is part of the list of insecure registries.  If `false`, the registry is insecure. Insecure registries accept un-encrypted (HTTP) and/or untrusted (HTTPS with certificates from unknown CAs) communication.  > **Warning**: Insecure registries can be useful when running a local > registry. However, because its use creates security vulnerabilities > it should ONLY be enabled for testing purposes. For increased > security, users should add their CA to their system's list of > trusted CAs instead of enabling this option.
     *
     * @return $this
     */
     ...
     * Sets official
     *
     * @param bool|null $official Indicates whether this is an official registry (i.e., Docker Hub / docker.io)
     *
     * @return $this
     */
