...
class Task implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'spec' => '\Piurafunk\Docker\Model\TaskSpec',
        'serviceID' => 'string',
        'slot' => 'int',
        'nodeID' => 'string',
        'assignedGenericResources' => 'object[]',
        'status' => '\Piurafunk\Docker\Model\TaskStatus',
        'desiredState' => '\Piurafunk\Docker\Model\TaskState'
    ];
     ...
     * Sets spec
     *
     * @param \Piurafunk\Docker\Model\TaskSpec|null $spec spec
     *
     * @return $this
     */
     ...
     * Sets serviceID
     *
     * @param string|null $serviceID The ID of the service this task is part of.
     *
     * @return $this
     */
     ...
     * Sets nodeID
     *
     * @param string|null $nodeID The ID of the node that this task is on.
     *
     * @return $this
     */
     ...
     *
     * @param object[]|null $assignedGenericResources User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`)
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \Piurafunk\Docker\Model\TaskStatus|null
     */
     ...
     * Sets status
     *
     * @param \Piurafunk\Docker\Model\TaskStatus|null $status status
     *
     * @return $this
     */
     ...
     * Gets desiredState
     *
     * @return \Piurafunk\Docker\Model\TaskState|null
     */
     ...
     * Sets desiredState
     *
     * @param \Piurafunk\Docker\Model\TaskState|null $desiredState desiredState
     *
     * @return $this
     */
