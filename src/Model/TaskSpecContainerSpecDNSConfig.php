 ...
 * @link     https://openapi-generator.tech
 */
class TaskSpecContainerSpecDNSConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaskSpec_ContainerSpec_DNSConfig';
     ...
     * Sets nameservers
     *
     * @param string[]|null $nameservers The IP addresses of the name servers.
     *
     * @return $this
     */
     ...
     * Sets search
     *
     * @param string[]|null $search A search list for host-name lookup.
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param string[]|null $options A list of internal resolver variables to be modified (e.g., `debug`, `ndots:3`, etc.).
     *
     * @return $this
     */
