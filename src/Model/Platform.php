 ...
 * @link     https://openapi-generator.tech
 */
class Platform implements ModelInterface, ArrayAccess
{
     ...
     * Sets architecture
     *
     * @param string|null $architecture Architecture represents the hardware architecture (for example, `x86_64`).
     *
     * @return $this
     */
     ...
     * Sets oS
     *
     * @param string|null $oS OS represents the Operating System (for example, `linux` or `windows`).
     *
     * @return $this
     */
