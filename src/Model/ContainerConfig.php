...
class ContainerConfig implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['argsEscaped'] = isset($data['argsEscaped']) ? $data['argsEscaped'] : null;
        ...
        $this->container['stopSignal'] = isset($data['stopSignal']) ? $data['stopSignal'] : 'SIGTERM';
     ...
     * Sets attachStdin
     *
     * @param bool|null $attachStdin Whether to attach to `stdin`.
     *
     * @return $this
     */
     ...
     * Sets attachStdout
     *
     * @param bool|null $attachStdout Whether to attach to `stdout`.
     *
     * @return $this
     */
     ...
     * Sets attachStderr
     *
     * @param bool|null $attachStderr Whether to attach to `stderr`.
     *
     * @return $this
     */
     ...
     * Sets exposedPorts
     *
     * @param map[string,object]|null $exposedPorts An object mapping ports to an empty object in the form:  `{\"<port>/<tcp|udp|sctp>\": {}}`
     *
     * @return $this
     */
     ...
     * Sets stdinOnce
     *
     * @param bool|null $stdinOnce Close `stdin` after one attached client disconnects
     *
     * @return $this
     */
     ...
     * Sets argsEscaped
     *
     * @param bool|null $argsEscaped Command is already escaped (Windows only)
     *
     * @return $this
     */
     ...
     * Sets volumes
     *
     * @param map[string,object]|null $volumes An object mapping mount point paths inside the container to empty objects.
     *
     * @return $this
     */
     ...
     * Sets workingDir
     *
     * @param string|null $workingDir The working directory for commands to run in.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $networkDisabled Disable networking for the container.
     *
     * @return $this
     */
     ...
     * Sets macAddress
     *
     * @param string|null $macAddress MAC address of the container.
     *
     * @return $this
     */
     ...
     * Sets onBuild
     *
     * @param string[]|null $onBuild `ONBUILD` metadata that were defined in the image's `Dockerfile`.
     *
     * @return $this
     */
     ...
     * Sets stopSignal
     *
     * @param string|null $stopSignal Signal to stop a container as a string or unsigned integer.
     *
     * @return $this
     */
     ...
     * Sets stopTimeout
     *
     * @param int|null $stopTimeout Timeout to stop a container in seconds.
     *
     * @return $this
     */
