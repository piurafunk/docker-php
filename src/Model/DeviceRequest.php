...
class DeviceRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets deviceIDs
     *
     * @param string[]|null $deviceIDs deviceIDs
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param map[string,string]|null $options Driver-specific options, specified as a key/value pairs. These options are passed directly to the driver.
     *
     * @return $this
     */
