...
class Runtime implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['runtimeArgs'] = isset($data['runtimeArgs']) ? $data['runtimeArgs'] : null;
    }
     ...
     * Sets path
     *
     * @param string|null $path Name and, optional, path, of the OCI executable binary.  If the path is omitted, the daemon searches the host's `$PATH` for the binary and uses the first result.
     *
     * @return $this
     */
    ...
    {
        return $this->container['runtimeArgs'];
    }

    /**
     * Sets runtimeArgs
     *
     * @param string[]|null $runtimeArgs List of command-line arguments to pass to the runtime when invoked.
     *
     * @return $this
     */
    public function setRuntimeArgs($runtimeArgs)
    {
        $this->container['runtimeArgs'] = $runtimeArgs;
