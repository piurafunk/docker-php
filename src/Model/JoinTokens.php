 ...
 * @link     https://openapi-generator.tech
 */
class JoinTokens implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JoinTokens';
     ...
     * Sets worker
     *
     * @param string|null $worker The token workers can use to join the swarm.
     *
     * @return $this
     */
     ...
     * Sets manager
     *
     * @param string|null $manager The token managers can use to join the swarm.
     *
     * @return $this
     */
