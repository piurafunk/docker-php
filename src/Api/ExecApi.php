...
class ExecApi
{
     ...
     * @param  \Piurafunk\Docker\Model\InlineObject $execConfig execConfig (required)
     *
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piurafunk\Docker\Model\IdResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse
     */
    public function containerExec($id, $execConfig)
    {
        list($response) = $this->containerExecWithHttpInfo($id, $execConfig);
        return $response;
    }
     ...
     *
     * @param  string $id ID or name of container (required)
     * @param  \Piurafunk\Docker\Model\InlineObject $execConfig (required)
     *
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piurafunk\Docker\Model\IdResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerExecWithHttpInfo($id, $execConfig)
    {
        $request = $this->containerExecRequest($id, $execConfig);
     ...
     */
    public function containerExecAsync($id, $execConfig)
    {
        return $this->containerExecAsyncWithHttpInfo($id, $execConfig)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerExecAsyncWithHttpInfo($id, $execConfig)
    {
        $returnType = '\Piurafunk\Docker\Model\IdResponse';
        $request = $this->containerExecRequest($id, $execConfig);
     ...
     */
    protected function containerExecRequest($id, $execConfig)
    {
        ...
        if ($execConfig === null || (is_array($execConfig) && count($execConfig) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $execConfig when calling containerExec'
            );
        }
     ...
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piurafunk\Docker\Model\ExecInspectResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piurafunk\Docker\Model\ExecInspectResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function execInspectWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Piurafunk\Docker\Model\ExecInspectResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piurafunk\Docker\Model\ExecInspectResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Piurafunk\Docker\Model\ExecInspectResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     *
     * @param  string $id Exec instance ID (required)
     * @param  \Piurafunk\Docker\Model\InlineObject1 $execStartConfig execStartConfig (optional)
     *
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function execStart($id, $execStartConfig = null)
    {
        $this->execStartWithHttpInfo($id, $execStartConfig);
    }
     ...
     *
     * @param  string $id Exec instance ID (required)
     * @param  \Piurafunk\Docker\Model\InlineObject1 $execStartConfig (optional)
     *
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function execStartWithHttpInfo($id, $execStartConfig = null)
    {
        $request = $this->execStartRequest($id, $execStartConfig);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function execStartAsync($id, $execStartConfig = null)
    {
        return $this->execStartAsyncWithHttpInfo($id, $execStartConfig)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function execStartAsyncWithHttpInfo($id, $execStartConfig = null)
    {
        $returnType = '';
        $request = $this->execStartRequest($id, $execStartConfig);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function execStartRequest($id, $execStartConfig = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($execStartConfig)) {
            $_tempBody = $execStartConfig;
        }
