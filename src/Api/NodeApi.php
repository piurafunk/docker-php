...
class NodeApi
{
     ...
     */
    protected function nodeDeleteRequest($id, $force = false)
    {
     ...
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piurafunk\Docker\Model\Node|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piurafunk\Docker\Model\Node|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function nodeInspectWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Piurafunk\Docker\Model\Node' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piurafunk\Docker\Model\Node', []),
            ...
            $returnType = '\Piurafunk\Docker\Model\Node';
            $responseBody = $response->getBody();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function nodeInspectRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piurafunk\Docker\Model\Node[]|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piurafunk\Docker\Model\Node[]|\Piurafunk\Docker\Model\ErrorResponse|\Piurafunk\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function nodeListRequest($filters = null)
    {
     ...
     * @param  \Piurafunk\Docker\Model\NodeSpec $body body (optional)
     *
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $id The ID of the node (required)
     * @param  int $version The version number of the node object being updated. This is required to avoid conflicting writes. (required)
     * @param  \Piurafunk\Docker\Model\NodeSpec $body (optional)
     *
     * @throws \Piurafunk\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function nodeUpdateRequest($id, $version, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
