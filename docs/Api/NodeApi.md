...
$apiInstance = new Piurafunk\Docker\Api\NodeApi(
...
> \Piurafunk\Docker\Model\Node nodeInspect($id)
...
[**\Piurafunk\Docker\Model\Node**](../Model/Node.md)
...
> \Piurafunk\Docker\Model\Node[] nodeList($filters)
...
$body = new \Piurafunk\Docker\Model\NodeSpec(); // \Piurafunk\Docker\Model\NodeSpec | 
 ...
 **body** | [**\Piurafunk\Docker\Model\NodeSpec**](../Model/NodeSpec.md)|  | [optional]
