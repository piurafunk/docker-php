...
> \Piurafunk\Docker\Model\Volume volumeCreate($volumeConfig)
...
$apiInstance = new Piurafunk\Docker\Api\VolumeApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$volumeConfig = new \Piurafunk\Docker\Model\VolumeConfig(); // \Piurafunk\Docker\Model\VolumeConfig | 

try {
    $result = $apiInstance->volumeCreate($volumeConfig);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **volumeConfig** | [**\Piurafunk\Docker\Model\VolumeConfig**](../Model/VolumeConfig.md)|  |

### Return type

[**\Piurafunk\Docker\Model\Volume**](../Model/Volume.md)
...
> \Piurafunk\Docker\Model\Volume volumeInspect($name)
...
> \Piurafunk\Docker\Model\VolumeListResponse volumeList($filters)
...
[**\Piurafunk\Docker\Model\VolumeListResponse**](../Model/VolumeListResponse.md)
...
> \Piurafunk\Docker\Model\VolumePruneResponse volumePrune($filters)
...
[**\Piurafunk\Docker\Model\VolumePruneResponse**](../Model/VolumePruneResponse.md)
