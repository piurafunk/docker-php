...
> \Piurafunk\Docker\Model\IdResponse configCreate($body)
...
> \Piurafunk\Docker\Model\Config configInspect($id)
...
[**\Piurafunk\Docker\Model\Config**](../Model/Config.md)
...
> \Piurafunk\Docker\Model\Config[] configList($filters)
...
$body = new \Piurafunk\Docker\Model\ConfigSpec(); // \Piurafunk\Docker\Model\ConfigSpec | The spec of the config to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [ConfigInspect endpoint](#operation/ConfigInspect) response values.
 ...
 **body** | [**\Piurafunk\Docker\Model\ConfigSpec**](../Model/ConfigSpec.md)| The spec of the config to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [ConfigInspect endpoint](#operation/ConfigInspect) response values. | [optional]
